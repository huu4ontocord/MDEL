...
def parse_args():
    ...
    parser.add_argument('--hf-repo', type=str, required=True, help='Name of the repo to upload the merged model e.g. MDEL/merged-arxiv-github')
    parser.add_argument('-e','--expert', action='append', help='Name of an expert repo e.g MDEL/expert-arxiv (use this flag multiple times)', required=True, dest='experts')
